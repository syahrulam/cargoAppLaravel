    ...
    <div class="col-12">
      <div class="card mb-4">
        ...
        <div class="card-body px-0 pt-0 pb-2">
          ...
          @endif
          <form method="post" action="/pelanggan/{{ $customer->id }}/update" enctype="multipart/form-data">
            @method('put')
            @csrf
            <div class="card-body">
                <div class="row form-group">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control input-bb" type="text" name="nama" id="nama" value="{{ $customer->nama}}"/>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <a class="text-dark">Email<a class='red'> *</a></a>
                            <input class="form-control input-bb" type="text" name="email" id="email" value="{{ $customer->email}}"/>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                              <input class="form-control input-bb" type="text" name="nomor" id="nomor" value="{{ $customer->nomor}}"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                              <input class="form-control input-bb" type="text" name="alamat" id="alamat" value="{{ $customer->alamat}}"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
