    ...
    <div class="col-12">
      <div class="card mb-4">
        ...
        <div class="card-body px-0 pt-0 pb-2">
          ...
          @endif
          <form method="post" action="/armada/created" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control input-bb" type="text" name="max_weight" id="max_weight"/>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                              <input class="form-control input-bb" type="text" name="length" id="length"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                              <input class="form-control input-bb" type="text" name="width" id="width"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                              <input class="form-control input-bb" type="text" name="height" id="height"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
